...
def run(args):
    ...
    for circuit_cls in ALL_CIRCUITS:
        ...
        if not args.no_save:
            flush_results(results, f"exp1_routing{('_' + args.sdk) if args.sdk else ''}.csv", pbar)
